...
import com.example.compose.jetchat.data.remoteMessages
...
fun ConversationContent(
    ...
    Scaffold(
        ...
        Column(
            ...
            LaunchedEffect(remoteMessages.size) {
                if (remoteMessages.isNotEmpty()) {
                    remoteMessages.forEach { text ->
                        uiState.addMessage(
                            Message(author = "Server", content = text, timestamp = "Now")
                        )
                    }
                }
            }
